...
SECRET_KEY = ')mawg6*=lr!e(7!29j5kh%+f*dd49s7#a7zd$^@9*c4+9gm=^1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # include templates for rendering html file
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# MEDIA_ROOT is local path where the images is
